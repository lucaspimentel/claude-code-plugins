...
| [lucas-dev-tools](plugins/lucas-dev-tools/README.md) | 1.24.0 | Developer workflow utilities for day-to-day use |
| [windows-notify](plugins/windows-notify/README.md) | 1.3.0 | Windows toast notifications *(Windows / WSL only)* |
