...
| [linters](plugins/linters/README.md) | 1.1.3 | Auto-lint edited files via PostToolUse hooks |
| [lucas-dev-tools](plugins/lucas-dev-tools/README.md) | 1.14.7 | Developer workflow utilities for day-to-day use |
