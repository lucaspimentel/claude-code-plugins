...
- [ ] Add `paths:` auto-invocation scoping to file-type-specific skills
    - `plugins/linters/skills/fix-cslint/SKILL.md` → `paths: ["**/*.cs", "**/*.csproj", "**/*.sln", "**/Directory.Build.props"]`
    - `plugins/lucas-dev-tools/skills/update-github-actions/SKILL.md` → `paths: [".github/workflows/**"]`
    - `plugins/chezmoi/skills/chezmoi-diff/SKILL.md` → paths under chezmoi source dir
    - Docs: https://code.claude.com/docs/en/skills#frontmatter-reference (see `paths` field)
