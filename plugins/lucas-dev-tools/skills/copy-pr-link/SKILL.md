---
name: copy-pr-link
description: "Copies a GitHub PR link as markdown to the clipboard. Accepts an optional PR number argument; defaults to the current branch's PR."
when_to_use: "Use when the user says 'copy pr link', 'pr markdown', 'copy pr url', 'link to pr', 'pr link', or any variation of wanting a GitHub PR link formatted as markdown."
