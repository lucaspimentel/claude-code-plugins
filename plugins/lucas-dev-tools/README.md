...
| `review-pr-ultra` | Deep PR review that fans out to multiple review engines in parallel and collates findings |
...
| `whats-next` | Pick, plan, and execute the next task from TODO.md |
